...
def posting():
    ...
    def send_json1(sendjson1):
        sendjson1 = post("http://127.0.0.1:5002/depart", json=sendjson1, headers={"Content-type": "application/json"})
        print(sendjson1.text)
    def send_json2(sendjson2):
        sendjson2 = post("http://127.0.0.1:5002/team", json=sendjson2, headers={"Content-type": "application/json"})
        print(sendjson2.text)
    def send_json3(sendjson3):
        sendjson3 = post("http://127.0.0.1:5002/users", json=sendjson3, headers={"Content-type": "application/json"})
